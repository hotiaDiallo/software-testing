...
import com.selftaugh.testing.customer.Customer;
import com.selftaugh.testing.customer.CustomerRegistrationRequest;
import com.selftaugh.testing.payment.Currency;
import com.selftaugh.testing.payment.Payment;
import com.selftaugh.testing.payment.PaymentRepository;
import com.selftaugh.testing.payment.PaymentRequest;
...
public class PaymentIntegrationTest {
    ...
    @Autowired
    private PaymentRepository paymentRepository; // only because we do not have an endpoint for the list of payments
    @Autowired
